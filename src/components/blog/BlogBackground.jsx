  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-0 left-1/2 -translate-x-1/2 w-[350px] sm:w-[500px] h-[280px] bg-blue-500/15 rounded-full blur-[90px]"
      />
      <div className="absolute -bottom-10 -right-10 w-72 h-72 bg-teal-400/15 rounded-full blur-3xl" />
      <motion.div
